...
public class CLIParser implements Runnable, Cancellable {
	...
	public CLIParser(SimpleServentListener listener) {
		...
		commandList.add(new RemoveCommand(listener.getMutex()));
		commandList.add(new AddCommand(listener.getMutex()));
		commandList.add(new CommitCommand(listener.getMutex()));

		commandList.add(new ViewCommand());
		commandList.add(new PushResolveCommand());
		commandList.add(new PullResolveCommand());

		commandList.add(new PushCommand());
		commandList.add(new PullCommand(listener.getMutex()));

		commandList.add(new DHTGetCommand(listener.getMutex()));
		commandList.add(new DHTPutCommand(listener.getMutex()));

		commandList.add(new QuitCommand(this, listener, listener.getMutex()));
	}
