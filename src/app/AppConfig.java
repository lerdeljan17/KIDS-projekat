...
public class AppConfig {
	...
	public static void readConfig(String configName, int serventId){
		...
		String workingDirProperty = "servent"+serventId+".working";
		String working = properties.getProperty(workingDirProperty);
		
		
		String storageDirProperty = "servent"+serventId+".storage";
		String storage = properties.getProperty(storageDirProperty);
		...
		myServentInfo = new ServentInfo("localhost", serventPort,working,storage);
	}
