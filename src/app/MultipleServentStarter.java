	...
	private static void startServentTest(String testName) {
		...
		for(int i = 0; i < serventCount; i++) {
			try {
				...
				AppConfig.timestampedErrorPrint("MultipleServentStarter -> startServentTest 1 : " + Arrays.toString(e.getStackTrace()));
			}
		...
		for (Process process : serventProcesses) {
			try {
				...
				AppConfig.timestampedErrorPrint("MultipleServentStarter -> startServentTest 2 : " + Arrays.toString(e.getStackTrace()));
			}
		}
		...
		try {
			...
			AppConfig.timestampedErrorPrint("MultipleServentStarter -> startServentTest 3 : " + Arrays.toString(e.getStackTrace()));
		}
	}
